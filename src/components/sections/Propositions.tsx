...
export function Propositions() {
  return (
    <section
      id="propositions"
      className="min-h-screen flex justify-center px-5 md:px-20 lg:px-28 pb-26 pt-12 md:pt-20  md:snap-start md:snap-always bg-background-tertiary!"
    >
      <div className="flex flex-col md:flex-row flex-wrap gap-5 md:gap-6 items-start">
        {propositions.map((item, index) => (
          <FadeInUp
            ...
            className={cn(
              "flex-1 rounded-lg bg-white/3 p-8 md:p-6 lg:p-8 min-w-60",
              index === 1 && "md:self-end"
            )}
          >
