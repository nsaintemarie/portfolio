...
export function About() {
  return (
    <section
      id="a-propos"
      className="min-h-screen max-h-screen flex flex-col gap-6 lg:gap-10 px-12 lg:px-28 py-20 lg:pt-16 lg:pb-24 snap-start snap-always overflow-hidden"
    >
      {/* Row 1: Title + Image 2 (portrait) */}
      <div className="flex gap-6 lg:gap-20 flex-1 justify-between">
        {/* Title */}
      ...
      <div className="flex gap-6 lg:gap-10 flex-1">
        ...
        <FadeIn delay={1.2} className="max-w-7/12 grid grid-cols-1 xl:grid-cols-2 gap-6 xl:gap-12 pt-4 pl-10">
          ...
          <p className="text-paragraph-line opacity-80 self-end -mb-10">
