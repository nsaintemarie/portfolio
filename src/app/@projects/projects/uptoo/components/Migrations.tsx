  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 md:gap-16 py-12 md:py-16 border-b border-background-secondary/10 last:border-b-0">
      <div className="flex-none md:w-46 md:pr-10 ">
        <div className="flex md:flex-col md:gap-1 gap-x-2 items-center md:items-start">
          <p className="text-heading-sm font-light opacity-50 leading-snug uppercase">{desc.title.from}</p>
          <p className="text-paragraph opacity-25 my-1 hidden md:block">↓</p>
          <p className="text-paragraph opacity-25 my-1 md:hidden block">→</p>
          <p className="text-heading-sm font-semibold leading-snug uppercase">{desc.title.to}</p>
